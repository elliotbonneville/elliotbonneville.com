...
This wasn't my first time. The day before, I'd posted [a contrary take on AI and money](/the-only-moat-left-is-money/) that briefly hit #1. That's the other route: an opinion strong enough and current enough that people need to argue with it. Two different mechanisms, same principle. Know what the audience engages with and give them exactly that.
