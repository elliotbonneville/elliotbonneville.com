...
For text input, I use [Wispr Flow](https://wisprflow.ai) for voice-to-text. Instead of pecking at a tiny keyboard, I just talk. It handles technical terms and code surprisingly well. Between Wispr for input and the PageUp binding for scrolling, the phone keyboard becomes almost optional.
...
- [tmux.conf](https://github.com/elliotbonneville/dotfiles/blob/main/tmux/tmux.conf) - keybindings
